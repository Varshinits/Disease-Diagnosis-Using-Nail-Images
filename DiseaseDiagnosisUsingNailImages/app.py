...
MODEL_PATH = 'models/DenseNetVGG16.h5'
...
def predict():
    if request.method == 'POST':
        ...
        output = ['Darier_s disease','Healthy nail','Muehrck-e_s lines','Onychogryphosis','Onycholycis_NailPsoriasis',
        ...
        output = ['AlopeciaAreata_DariersDisease','BeausLines','BluishNail','HalfMoonRedBands',
                  ...
                  'Onycholycis_NailPsoriasis_Onychomycosis','SplinterHemmorrage_AcralLentiginousMelanoma',
                  'TerrysNail_WhiteNails_LindsaysNails_PaleNails','YellowNails']'''
